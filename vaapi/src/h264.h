...
// PS:Comment are those parameters mostly the same?
// things like bit_depth_luma etc i mostly never heard of
...
// PS:Comment same problem here. most of these values i dont know how to extract from the stream parameters
